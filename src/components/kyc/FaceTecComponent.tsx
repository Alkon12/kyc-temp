...
class FaceTecComponentClass extends React.Component<FaceTecComponentProps, FaceTecState> {
  ...
  initializeSDK = () => {
    try {
      ...
      // Usar la configuración del Config.js que incluye la localización en español
      Config.initializeFromAutogeneratedConfig(FaceTecSDK, (success: boolean): void => {
        if (success) {
          this.sdkLoaded = true;
          this.setState({ 
            status: "SDK inicializado y listo con localización en español",
            progress: 100
          });
          ...
          if (this.props.onError) {
            this.props.onError("Error al inicializar FaceTec SDK");
          }
        }
      });
    } catch (error) {
      ...
      if (this.props.onError) {
        this.props.onError("Error en la configuración de FaceTec");
      }
    }
  };
