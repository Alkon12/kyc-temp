...
const CardCategory1: FC<CardCategory1Props> = ({ className = '', size = 'normal', taxonomy }) => {
  ...
  return (
    <Link href={href} className={`nc-CardCategory1 flex items-center ${className}`} data-nc-id="CardCategory1">
      <div
        className={`flex-shrink-0 relative ${size === 'large' ? 'w-20 h-20' : 'w-12 h-12'} rounded-lg mr-4 overflow-hidden`}
      >
