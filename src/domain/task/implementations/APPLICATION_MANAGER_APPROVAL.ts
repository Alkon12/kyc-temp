...
export const APPLICATION_MANAGER_APPROVAL: TaskTypeConfig = {
  ...
  accept: async (args, services) => {
    ...
    console.log('APPLICATION_MANAGER_APPROVAL ACCEPTED')
    await services.applicationChecklistService.complete({
      userId: args.userId,
      applicationId: application.getId(),
      prospectId: application.getProspectId(),
      checklistId: ChecklistId.ONBOARD_MANAGER_APPROVAL,
    })
